...
using UrlFragmentIdentifierCleaner.Models;

namespace UrlFragmentIdentifierCleaner.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("UrlFragmentIdentifierCleaner.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("UrlFragmentIdentifierCleaner.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
